...
export default function StudentDetails() {
  const [selectedStudent, setSelectedStudent] = useState(studentDetailsData.students[0]);

  return (
    <div className="space-y-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">学生详情</h1>
        <div className="mt-4 sm:mt-0">
          ...
          >
            {studentDetailsData.students.map((student) => (
      ...
      <div className="grid grid-cols-1 gap-8 lg:grid-cols-2">
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <div className="h-[400px]">
            <ResponsiveContainer width="100%" height="100%">
              <RadarChart
                data={selectedStudent.scores.map((score) => ({
