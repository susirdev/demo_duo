  ...
  return (
    <div className="space-y-8">
      <div className="sm:flex sm:items-center sm:justify-between">
        <h1 className="text-2xl font-semibold text-gray-900">考试记录</h1>
      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="mt-2 text-3xl font-semibold text-gray-900">{selectedExam.totalScore}</p>
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          ...
          <p className="mt-2 text-3xl font-semibold text-gray-900">第 {selectedExam.rank} 名</p>
          <p className="mt-1 text-sm text-gray-500">共 30 名学生</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
          <h3 className="text-sm font-medium text-gray-500">考试日期</h3>
          <p className="mt-2 text-3xl font-semibold text-gray-900">{selectedExam.date}</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow">
      ...
      {/* 各科成绩对比 */}
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-lg font-medium text-gray-900 mb-6">各科成绩对比</h2>
      ...
      {/* 考试分析 */}
      <div className="bg-white p-6 rounded-lg shadow">
        <h2 className="text-lg font-medium text-gray-900 mb-6">考试分析</h2>
        <div className="space-y-6">
          {selectedExam.subjectScores.map((subject) => {
            ...
            return (
              <div key={subject.subject} className="flex items-start">
